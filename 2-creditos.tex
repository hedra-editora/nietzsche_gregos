...
\textbf{tradução©}\quad			 			 {Fernando R.~de Moraes Barros}\\
\textbf{organização©}\quad			 		 {}\\
\textbf{introdução©}\quad			 		 {Fernando R.~de Moraes Barros}\\
%\textbf{ilustração©}\quad			 		 {copyrightilustracao}\medskip

\textbf{título original}\quad			 	 {Die Philosophie im tragischen Zeitalter der Griechen}\\
